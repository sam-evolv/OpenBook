      ...
      >
        <div className="px-5 pt-12 pb-0">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 style={{ fontSize: 22, fontWeight: 900, color: '#fff', letterSpacing: '-0.02em', margin: 0 }}>
            ...
            <div className="flex flex-col gap-3">
              {filteredNearby.map((b) => (
                ...
                >
                  ...
                  {b.distance && (
                    <div style={{ padding: '0 12px 0 0', display: 'flex', alignItems: 'center', flexShrink: 0 }}>
        ...
        {noResults && (
          <div style={{ textAlign: 'center', paddingTop: 60, color: 'rgba(255,255,255,0.35)', fontSize: 14 }}>
            ...
            <p>
              ...
              <strong style={{ color: 'rgba(255,255,255,0.6)' }}>{activeCategory}</strong>
            </p>
          </div>
        )}
      </div>
