 ...
 *
 *   €30                ← 52px Fraunces, gold
 *   €̶5̶0̶ usually      ← 14px Geist, zinc-500, strikethrough on the price
 *   You save €20 (40% off) ← 13px Geist, gold weight 500
 *
 * Free sales (sale_price_cents === 0) render "Free" instead of the
 * savings line. Pure server component.
 */
...
export function PriceBlock({
  ...
  return (
    <div className="flex flex-col items-center gap-2 text-center">
      <span className="font-serif text-[52px] font-medium leading-none text-[#D4AF37]">
