...
import { cn, formatPrice, getDurationLabel } from '@/lib/utils'
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[12px] text-gray-400 mt-0.5">
          ...
          {(service.capacity ?? 1) > 1 ? ` · Group up to ${service.capacity}` : ''}
        </p>
      </div>
      <div className="flex items-center gap-3 shrink-0">
        <span className="text-[15px] font-bold text-gray-900">{formatPrice(service.price_cents)}</span>
        <div
          className={cn(
